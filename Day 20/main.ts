...
let addMarks:number =averageScore.marksInEng+averageScore.marksInMaths+averageScore.marksInPhy+averageScore.marksInChem+averageScore.marksInUrdu+averageScore.marksInBioOrComp+averageScore.marksInIsl;
...
function magicbox(digit: number) {
